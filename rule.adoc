...
If the robot can find its way back to the starting tile, it will receive an exit bonus.  Suppose the robot can find its way back to the starting tile after exploring the maze. In that case, it will receive 10 bonus points per identified victim as an exit bonus. 
