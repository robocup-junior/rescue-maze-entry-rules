...
... Silver tiles in the field have two means depending on the Class.
.... [Beginner]  Silver tile in the field represents the starting tile.
.... [Intermediate]  Silver tiles in the field represent checkpoints.
