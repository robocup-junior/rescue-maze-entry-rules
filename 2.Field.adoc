...
. Teams must prepare for the pathways to be slightly smaller due to the walls not being indefinitely thin. That leads that the pathway between two opposite walls is 28 cm wide.
