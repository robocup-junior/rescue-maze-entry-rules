...
. 【Intermediate】 Once the robot starts moving as the scoring run begins, a referee will place the black  and silver tiles.
+
【Beginner】 Once the robot starts moving as the scoring run begins, a referee will place the black tiles.
...
+
【Beginner】　If a robot restarts after a LoP and simultaneously performs a detection, it will not be accepted.
...
.. 【Intermediate】On floating tiles :  30 points
...
. 【intermediate】The Reliability Bonus is a non-negative number and calculated from the number of successful victim identifications (SVI) and the total number of Lack of Progresses (LoP) as such:
